...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108tzhang54";
	public static final String MYSQL_PASSWORD = "oozuphie";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_tzhang54";
	
/*	public static final String MYSQL_USERNAME = "ccs108jzhu87";
	public static final String MYSQL_PASSWORD = "zomujaid";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user-master.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_jzhu87";*/
